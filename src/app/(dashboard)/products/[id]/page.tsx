...
export default function ProductDetailPage() {
  ...
  return (
    <div className="max-w-lg mx-auto space-y-6">
      <div className="flex items-center gap-3">
        <button onClick={() => router.push('/products')} className="p-2 text-[var(--ink-tertiary)] hover:text-[var(--ink)] hover:bg-[var(--surface-1)] rounded-[var(--radius-sm)] transition-colors cursor-pointer">
          <ArrowLeft size={20} />
        </button>
